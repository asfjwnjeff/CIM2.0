...
export default function ServiceEntitiesPage() {
  ...
  const handleDelete = (id: string, name: string) => {
    if (!confirm(`确定要删除服务主体"${name}"吗？`)) return;
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <h1 className="text-2xl font-bold text-[#0A0A0A]">服务主体管理</h1>
            <p className="text-[#5A5A5A] text-[13px] mt-0.5">管理所有服务主体信息，包括基本信息、联系方式和税务数据</p>
          </div>
          <button
            ...
            <table className="w-full">
              ...
              <tbody>
                {filteredEntities.length === 0 ? (
                  <tr>
                    <td colSpan={8} className="text-center text-[#999999] py-12 text-sm">暂无服务主体数据</td>
                  </tr>
                ) : (

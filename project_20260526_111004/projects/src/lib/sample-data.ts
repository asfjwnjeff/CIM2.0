...
export const INDUSTRY_CHAIN_LEVEL_COLORS: Record<string, { bg: string; text: string }> = {
  upstream: { bg: 'bg-[#E8F0FF]', text: 'text-[#1A2FFF]' },
...
export const initialCustomers: Customer[] = [
  {
    ...
    signingEntity: '应用材料（中国）有限公司',
    serviceEntity: '应用材料（中国）有限公司',
    status: 'active',
    createdBy: 'user-1',
  ...
  },
  {
    ...
    signingEntity: '金鹰国际货运代理有限公司',
    serviceEntity: '飞雅贸易（上海）有限公司（FEIS）',
    status: 'active',
    createdBy: 'user-1',
  ...
  },
  {
    ...
    signingEntity: '苏斯贸易（上海）有限公司',
    serviceEntity: '苏斯贸易（上海）有限公司',
    status: 'active',
    createdBy: 'user-2',
  ...
  },
  {
    ...
    signingEntity: '昇先创科技（深圳）有限公司',
    serviceEntity: '昇先创科技（深圳）有限公司',
    status: 'active',
    createdBy: 'user-1',
    responsiblePersons: ['user-2'],
  ...
  },
  {
    ...
    signingEntity: '上海华力集成电路有限公司',
    serviceEntity: '上海华力集成电路有限公司',
    status: 'active',
    createdBy: 'user-2',
    responsiblePersons: ['user-4'],
    collaborators: [],
  ...
  // 荏原
  {
    ...
    signingEntity: 'EBARA 上海荏原精密机械有限公司',
    serviceEntity: 'EBARA 上海荏原精密机械有限公司',
    status: 'active',
    createdBy: 'user-1',
    responsiblePersons: ['user-5'],
  ...
  // 西安岛津
  {
    ...
    signingEntity: 'DJQY岛津企业管理（中国）有限公司',
    serviceEntity: 'DJQY岛津企业管理（中国）有限公司',
    status: 'active',
    createdBy: 'user-2',

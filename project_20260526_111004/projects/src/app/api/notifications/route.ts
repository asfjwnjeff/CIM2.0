...
let notifications: NotificationItem[] = [
  ...
  { id: 'n4', userId: 'user-1', type: 'approval_pending', title: '新的审批待办', summary: '苏斯贸易(上海)有限公司 的运输服务审批需要您处理', targetUrl: '/mobile/approvals/1', isRead: false, createdAt: new Date(Date.now() - 2400000).toISOString() },
  { id: 'n5', userId: 'user-1', type: 'approval_result', title: '审批已驳回', summary: '上海裘瑞经贸有限公司 的进出口服务审批已被驳回', targetUrl: '/mobile/approvals/3', isRead: false, createdAt: new Date(Date.now() - 7200000).toISOString() },
];

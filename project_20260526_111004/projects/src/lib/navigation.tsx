...
export const NavIcons = {
  ...
  Landmark: () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 21h18M4 3h16M4 7h16M4 11h16M4 15h16M4 19h16M8 3v16M16 3v16" />
    </svg>
  ),
  Settings: () => (
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: '地址主数据', href: '/addresses', icon: <NavIcons.MapPin />, permissionCode: 'addresses:view' },

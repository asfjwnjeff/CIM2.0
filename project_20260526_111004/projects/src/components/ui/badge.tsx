...
const badgeVariants = cva(
  "inline-flex items-center justify-center rounded-md border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive overflow-hidden",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-[#E8EBFF] text-[#2D3BFF]",
        secondary:
          "border-transparent bg-[#F5F5F5] text-[#5A5A5A]",
        destructive:
          "border-transparent bg-[#FFEBEE] text-[#D63031] focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40",
        outline:
          "border-[#D5D5D5] text-[#5A5A5A]",
        success:
          "border-transparent bg-[#E6F7F0] text-[#0D8A5E]",
        warning:
          "border-transparent bg-[#FFF4E8] text-[#E8850C]",
      },
    },
    defaultVariants: {
      variant: "default",

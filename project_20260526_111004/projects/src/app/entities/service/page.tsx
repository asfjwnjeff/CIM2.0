    ...
    <AppLayout>
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          <h1 className="text-xl font-semibold text-on-surface">服务主体管理</h1>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={() => router.push('/entities/service/new')}
            ...
            {filteredEntities.length === 0 ? (
              ...
              filteredEntities.map((entity) => (
                ...
                >
                  ...
                  <span className="text-sm text-on-surface-variant">{entity.contactPerson || '-'}</span>
                  <span className="text-sm text-on-surface-variant">{entity.contactPhone || '-'}</span>
                  <span>

...
export const initialAutoApprovalRules: AutoApprovalRule[] = [
  ...
  },
  {
    ...
    actions: [{ type: 'show_message' as const, message: '注册资本不足100万，建议人工审核' }],
  ...
  },
  {
    ...
    actions: [{ type: 'show_message' as const, message: '社保人数不足10人，建议人工审核' }],
  ...
  },
  {
    ...
    actions: [{ type: 'show_message' as const, message: '出货地区为战争地区，建议人工审核' }],
  ...
  },
  {
    ...
    actions: [{ type: 'show_message' as const, message: '客户要求的运输及时率>99%过于严苛，CIM作为供应商可能无法达到，建议评估KPI可行性' }],
  ...
  },
  {
    ...
    conditionLogic: 'AND' as const,
    conditions: [
      { field: 'transport_product_type', operator: 'contains' as const, value: '其他' },
    ],
    actions: [
      { type: 'show_message' as const, message: '非标准运输产品，需人工审核' },
    ],
    priority: 8,
    createdBy: 'system', createdAt: '2026-06-03T10:00:00Z',
  },
  {
    id: 'ar-009',
    name: '仓库条件不满足提醒',
    ...
    conditionLogic: 'AND' as const,
    conditions: [
      { field: 'area_requirement', operator: 'less_than' as const, value: '500' },
      { field: 'warehouse_region', operator: 'not_contains' as const, value: '上海' },
      { field: 'warehouse_region', operator: 'not_contains' as const, value: '武汉' },
      { field: 'warehouse_region', operator: 'not_contains' as const, value: '成都' },
    ],
    actions: [
      { type: 'show_message' as const, message: '仓库面积不足500㎡且未选择核心城市（上海/武汉/成都），需人工检查' },
    ],
    priority: 9,
    createdBy: 'system', createdAt: '2026-06-03T10:00:00Z',
  },
...
export const initialCustomers: Customer[] = [
  {
    ...
    boundCustomers: [
      { customerId: 'cust-cpq-001', customerName: '应用材料半导体服务（上海）有限公司', entityType: 'service', unifiedSocialCreditCode: '91310000MA1FL5SS1S' },
      { customerId: 'cust-cpq-004', customerName: '应用材料设备维修服务（上海）有限公司', entityType: 'service', unifiedSocialCreditCode: '91310000MA1FL5SM4M' },
      { customerId: 'cust-cpq-002', customerName: '应用材料半导体结算中心（上海）有限公司', entityType: 'settlement', unifiedSocialCreditCode: '91310000MA1FL5ST1T' },
    ],
  },
  {
    id: 'cust-002',
    name: '金鹰国际货运代理有限公司',
    customerCode: 'JYHY001',
    ...
    collaborators: ['user-1', 'user-4', 'user-5'],
    progressStatus: 'opportunity_confirmed',
    createdAt: '2024-01-01',
    basicInfo: {
      unifiedSocialCreditCode: '91310000MA1FL7JY3Z',
      countryRegion: '中资',
      industryCategory: '半导体',
      mainProducts: '国际货运代理、半导体设备物流、保税仓储',
      industryChainFormat: '物流业',
      supplyChainRole: '物流服务商',
      crossBorderMode: '口岸',
      customerChannel: '直客',
      customerSource: '展会',
      customerLevel: 'A',
      potentialCompetitors: '中国外运、中远海运物流',
      relatedEnterprises: '金鹰国际物流集团',
      addressProvince: '上海市',
      addressCity: '上海市',
      addressDistrict: '浦东新区',
      addressDetail: '外高桥保税区XX号',
      intendedServiceRegions: ['上海', '深圳', '北京', '成都'],
      serviceProducts: ['货代', '运输', '仓储'],
      estimatedMonthlyVolume: '500',
      warehouseArea: '3000',
      warehouseConditions: '恒温恒湿（20-25°C，40-60%RH）',
      ourAdvantage: '保税仓储资源丰富，通关效率高',
      ourDisadvantage: '内陆运输网络覆盖不足',
    },
    businessInfo: {
      paidInCapital: '5000万人民币',
      organizationCode: 'MA1FL7JY3',
      businessRegistrationNumber: '31000040030ZZZZ',
      taxpayerIdentificationNumber: '91310000MA1FL7JY3Z',
      enterpriseType: '有限责任公司',
      businessTerm: '2005-03-15 至 2055-03-14',
      taxpayerQualification: '一般纳税人',
      staffSize: '500-1000人',
      insuredNumber: '680',
      approvalDate: '2023-06-20',
      ...
      englishName: 'Golden Eagle International Freight Forwarding Co., Ltd.',
      registeredAddress: '上海市浦东新区外高桥保税区XX号',
      correspondenceAddress: '上海市浦东新区外高桥保税区XX号',
      businessScope: '承办海运、空运进出口货物的国际运输代理业务；保税仓储；半导体设备专业物流等',
      phone: '021-58886666',
      registrationStatus: '存续',
      legalRepresentative: '赵建国',
      email: 'info@goldeneagle-logistics.com',
      enterpriseScale: '大型',
      registeredCapital: '5000万人民币',
      website: 'www.goldeneagle-logistics.com',
      establishmentDate: '2005-03-15',
      countryRegion: '中国',
      industryTags: ['物流', '货代', '保税仓储', '半导体物流'],
    },
    semiconductorInfo: {
      industryChainLevel: 'downstream',
      industryChainRole: 'distributor',
      industryTags: ['物流', '货代', '保税仓储', '半导体物流'],
    },
    relatedCompanies: [],
    products: [],
    auditLogs: [],
    boundCustomers: [
      { customerId: 'cust-cpq-003', customerName: '飞雅贸易（上海）有限公司', entityType: 'service', unifiedSocialCreditCode: '91310000MA1FL6YY2Y' },
      { customerId: 'cust-cpq-005', customerName: '赛默飞世尔科技（中国）有限公司', entityType: 'service', unifiedSocialCreditCode: '91310000607374000A' },
      { customerId: 'cust-cpq-005', customerName: '赛默飞世尔科技（中国）有限公司', entityType: 'settlement', unifiedSocialCreditCode: '91310000607374000A' },
    ],
  },
  {
    id: 'cust-003',
  ...
  // ====== CPQ 推送的服务/结算主体（仅核心字段，用于演示信息补全） ======
  {
    id: 'cust-cpq-001',
    name: '应用材料半导体服务（上海）有限公司',
    customerCode: 'AMTSS01',
    signingEntityIds: [],
    serviceEntityIds: ['svc-1'],
    settlementEntityIds: [],
    status: 'active',
    entityTypes: ['service'],
    sourceSystem: 'cpq' as const,
    createdBy: 'user-1',
    responsiblePersons: ['user-2'],
    collaborators: [],
    progressStatus: 'deal_closed',
    ...
    basicInfo: {
      unifiedSocialCreditCode: '91310000MA1FL5SS1S',
      countryRegion: '美企',
      industryCategory: '半导体',
      shortName: '应用材料服务',
    },
    boundCustomers: [
      { customerId: 'cust-001', customerName: '应用材料（中国）有限公司', entityType: 'signing', unifiedSocialCreditCode: '91310000MA1FL5XX1X' },
    ],
    auditLogs: [],
  },
  {
    id: 'cust-cpq-002',
    name: '应用材料半导体结算中心（上海）有限公司',
    customerCode: 'AMTST01',
    signingEntityIds: [],
    serviceEntityIds: [],
    settlementEntityIds: ['stl-1'],
    status: 'active',
    entityTypes: ['settlement'],
    sourceSystem: 'cpq' as const,
    createdBy: 'user-1',
    responsiblePersons: ['user-2'],
    collaborators: [],
    ...
    updatedAt: '2024-06-01',
    basicInfo: {
      unifiedSocialCreditCode: '91310000MA1FL5ST1T',
      countryRegion: '美企',
      shortName: '应用材料结算',
    },
    domesticFlag: 'domestic',
    settlementCycle: '月结30天',
    invoiceAddress: '上海市浦东新区张江高科技园区',
    bankAccounts: [
      { currency: 'CNY', bankName: '中国银行上海分行', accountNumber: '6222021001234567890' },
    ],
    settlementRelationType: 'service_entity',
    settlementRelationName: '应用材料半导体服务（上海）有限公司',
    boundCustomers: [
      { customerId: 'cust-cpq-001', customerName: '应用材料半导体服务（上海）有限公司', entityType: 'service', unifiedSocialCreditCode: '91310000MA1FL5SS1S' },
      { customerId: 'cust-001', customerName: '应用材料（中国）有限公司', entityType: 'signing', unifiedSocialCreditCode: '91310000MA1FL5XX1X' },
    ],
  ...
  },
  {
    ...
    domesticFlag: 'domestic',
    settlementCycle: '月结45天',
    invoiceAddress: '上海市浦东新区陆家嘴金融贸易区',
    boundCustomers: [
  ...
  {
    id: 'cust-cpq-004',
    name: '应用材料设备维修服务（上海）有限公司',
    customerCode: 'AMTSM01',
    signingEntityIds: [],
    serviceEntityIds: ['svc-4'],
    settlementEntityIds: [],
    status: 'active',
    ...
    basicInfo: {
      unifiedSocialCreditCode: '91310000MA1FL5SM4M',
      countryRegion: '美企',
      industryCategory: '半导体',
      shortName: '应用材料维修',
    },
  ...
  },
  {
    ...
    customerCode: 'SMFS001',
    signingEntityIds: [],
    serviceEntityIds: ['svc-5'],
    settlementEntityIds: ['stl-3'],
    status: 'active',
    entityTypes: ['service', 'settlement'],
    sourceSystem: 'cpq' as const,
    createdBy: 'user-1',
    responsiblePersons: ['user-3'],
    collaborators: [],
    ...
    basicInfo: {
      unifiedSocialCreditCode: '91310000607374000A',
      countryRegion: '美企',
      industryCategory: '半导体',
      shortName: '赛默飞世尔',
    },
    domesticFlag: 'domestic',
    settlementCycle: '月结60天',
    invoiceAddress: '上海市浦东新区金桥开发区XX号',
    bankAccounts: [
      { currency: 'CNY', bankName: '花旗银行上海分行', accountNumber: '6222021009876543210' },
      { currency: 'USD', bankName: 'Citibank Shanghai', accountNumber: '9876543210' },
    ],
    settlementRelationType: 'service_entity',
    settlementRelationName: '赛默飞世尔科技（中国）有限公司',
    boundCustomers: [
      { customerId: 'cust-002', customerName: '金鹰国际货运代理有限公司', entityType: 'signing', unifiedSocialCreditCode: '91310000MA1FL7JY3Z' },
    ],
    auditLogs: [],
...
export const initialApprovalFields: ApprovalField[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'opt-045', label: '南京', order: 3 },
      { id: 'opt-046', label: '合肥', order: 4 },
      { id: 'opt-047', label: '杭州', order: 5 },
      { id: 'opt-048', label: '武汉', order: 6 },
      { id: 'opt-049', label: '成都', order: 7 },
      { id: 'opt-050', label: '西安', order: 8 },
      { id: 'opt-051', label: '北京', order: 9 },
      { id: 'opt-052', label: '大连', order: 10 },
      { id: 'opt-053', label: '厦门', order: 11 },
      { id: 'opt-054', label: '深圳', order: 12 },
      { id: 'opt-055', label: '广州', order: 13 },
      { id: 'opt-056', label: '其他', order: 14 },
    ],
    isRequired: true, status: 'active',
    createdBy: 'system', createdAt: '2026-05-29T00:00:00Z',
  },
...
export const initialRiskApprovals = [
  {
    ...
    subsidiaryCompany: "",
    serviceProduct: "货代",
    monthly_orders: "11-20单", monthly_invoice_amount: "100000元以上",
    isTradeAgent: "否",
    businessType: "保税",
    goodsType: "半导体设备",
  ...
  },
  {
    ...
    monthly_orders: "6-10单", monthly_invoice_amount: "5001-20000元",
    dynamicFieldValues: {"area_requirement":"800","cargo_volume":"300","storage_type":"常温","warehouse_region":"上海","registered_capital":"1500","social_insurance_count":"120"},
  },
  {
    id: "3",
    ...
    subsidiaryCompany: "",
    serviceProduct: "运输",
    monthly_orders: "50单以上", monthly_invoice_amount: "20001-100000元",
    isTradeAgent: "是",
    businessType: "免税",
    goodsType: "精密仪器",
    ...
    dynamicFieldValues: {"on_time_rate":"95","service_regions":"华东,华南","registered_capital":"200","social_insurance_count":"45"},
  },
  {
    id: "4",
    ...
    subsidiaryCompany: "",
    serviceProduct: "进出口",
    monthly_orders: "50单以上", monthly_invoice_amount: "100000元以上",
    isTradeAgent: "否",
    businessType: "试单",
    goodsType: "化工原料",
  ...
  },
  {
    ...
    subsidiaryCompany: "",
    serviceProduct: "合同物流",
    monthly_orders: "21-50单", monthly_invoice_amount: "20001-100000元",
    isTradeAgent: "否",
    businessType: "保税",
    goodsType: "集成电路芯片",
    monthlyBusinessVolume: "101-500",
  ...
  },
  {
    ...
    subsidiaryCompany: "",
    serviceProduct: "关务",
    monthly_orders: "11-20单", monthly_invoice_amount: "20001-100000元",
    isTradeAgent: "否",
    businessType: "保税",
  ...
  },
  {
    ...
    dynamicFieldValues: {"on_time_rate":"99.5","registered_capital":"150","social_insurance_count":"12","service_regions":"上海,无锡,南京","transport_product_type":"海运进口","shipping_country":"日本","area_requirement":"800","cargo_volume":"500","warehouse_region":"上海,南京","storage_type":"恒温"},
  },
  {
    id: "8",
  ...
  },
  {
    ...
    subsidiaryCompany: "",
    serviceProduct: "运输",
    monthly_orders: "0-5单", monthly_invoice_amount: "0-5000元",
    isTradeAgent: "是",
    businessType: "保税",
    goodsType: "存储芯片/模组",
    monthlyBusinessVolume: "51-100",
    ...
    dynamicFieldValues: {"on_time_rate":"99.8","registered_capital":"60","social_insurance_count":"6","service_regions":"武汉,上海"},
    history: [],
...
export const initialFollowUps = [
  { id: 'fu-seed-1', customerId: 'cust-001', customerName: '应用材料（中国）有限公司', type: 'biz_meeting', method: 'onsite_visit', content: '季度业务回顾会议，讨论Q3合作计划', followUpDate: daysAgo(3), status: 'success', owner: 'user-2', createdAt: daysAgo(3) },
  ...
  { id: 'fu-seed-6', customerId: 'cust-007', customerName: '上海华力集成电路有限公司', type: 'biz_meeting', method: 'hmg_meeting', content: '28nm工艺产能协调会议', followUpDate: daysAgo(2), status: 'success', owner: 'user-4', createdAt: daysAgo(2) },
  { id: 'fu-seed-7', customerId: 'cust-008', customerName: '上海荏原精密机械有限公司', type: 'contract_mgmt', method: 'online_visit', content: 'CMP设备维保合同签订', followUpDate: daysAgo(1), status: 'success', owner: 'user-1', createdAt: daysAgo(1) },
